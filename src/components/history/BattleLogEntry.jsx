    ...
    <div className="bg-white/5 rounded-xl p-4">
      ...
      <div className="grid grid-cols-4 gap-2 mb-3">
        ...
        <div className="flex flex-col items-center bg-white/5 rounded-lg py-2">
          ...
          <span className="text-[9px] text-white/40">Duration</span>
        </div>
      </div>

      {h.distinctTypesUsed > 0 && (
        <p className="flex items-center gap-1 text-[10px] text-white/40 mb-2">
